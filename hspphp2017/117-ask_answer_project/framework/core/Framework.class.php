...
class Framework
{
    ...
    private function initConst()
    {
        ...
        // 公共的资源目录
        define('PUBLIC_PATH', '/hspphp2017/117-ask_answer_project/application/public/');
        // 文件上传的目录
...
//        $controller = new \home\controller\IndexController();
