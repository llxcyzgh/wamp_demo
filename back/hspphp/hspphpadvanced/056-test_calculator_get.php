...
// 让表单提交后再运行php代码
    ...
    $num1 = isset($_GET['num1']) && is_numeric($_GET['num1']) ? $_POST['num1'] : '';
    $num2 = isset($_GET['num2']) && is_numeric($_GET['num2']) ? $_POST['num2'] : '';
    $oper = $_POST['operator'];
    $res  = 0;
    if ($num1 == '' || $num2 == '') {
...
<body>
<form action="55-test_calculator.php" method="get" onsubmit="checkForm()">
